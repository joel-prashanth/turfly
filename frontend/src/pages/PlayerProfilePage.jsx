    ...
    <Container className="py-8">
      ...
      <div className="grid gap-6 xl:grid-cols-[280px_1fr]">
        ...
        <Card className="flex flex-col items-center p-8 text-center">
          <div className="relative">
            <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-3xl bg-emerald-100 text-3xl font-bold text-emerald-700">
              {user?.avatarUrl ? (
                <img
                  src={user.avatarUrl}
                  alt={user?.name}
            ...
            <button
              ...
              className="absolute -bottom-2 -right-2 flex h-9 w-9 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:bg-emerald-50 hover:text-emerald-700 disabled:opacity-50"
            >
          ...
          <span className="mt-4 rounded-full bg-emerald-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-emerald-700">
            Player
          </span>
